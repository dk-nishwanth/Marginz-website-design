    ...
    <div className="animate-in fade-in duration-1000">
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <div className="grid grid-cols-2 gap-8 mb-16">
                <div className="p-8 bg-white border-l-4 border-[#165a72] shadow-sm">
                ...
                <div className="p-8 bg-white border-l-4 border-[#ed1c24] shadow-sm">
            ...
            <div className="space-y-8">
              <div className="aspect-[4/3] overflow-hidden shadow-2xl border border-black/5 relative group">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="p-6 bg-white shadow-sm border-l-4 border-[#165a72] hover:shadow-lg transition-shadow">
                ...
                <div className="p-6 bg-white shadow-sm border-l-4 border-[#ed1c24] hover:shadow-lg transition-shadow">
                  <div className="flex items-center gap-3 mb-4">
        ...
        <div className="max-w-[1800px] mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="group relative overflow-hidden bg-white shadow-sm hover:shadow-2xl transition-all duration-700 p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="w-8 h-[1px] bg-[#165a72]/20"></div>
                  </div>
      ...
      <section className="py-40 bg-[#f8f9fa] border-t border-black/5">
        <div className="max-w-[1800px] mx-auto px-6 md:px-12">
          ...
          <div className="flex justify-center items-center gap-16 flex-wrap opacity-60 hover:opacity-100 transition-opacity">
            {[
