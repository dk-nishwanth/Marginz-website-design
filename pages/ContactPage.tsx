    ...
    <div className="pt-48 bg-white text-black min-h-screen pb-40">
      ...
      <section className="px-6 md:px-12 max-w-[1800px] mx-auto grid lg:grid-cols-2 gap-24 mb-40">
        ...
        <div className="space-y-16">
          <div>
            <h2 className="font-heading text-5xl font-bold uppercase tracking-tighter mb-8 text-[#0B4F6C]">
              Contact Information
            </h2>
          ...
          <div className="space-y-12">
            {[
              ...
              <div key={info.label} className="flex gap-8 items-start">
                <div className="w-16 h-16 bg-[#0B4F6C]/5 flex items-center justify-center rounded-2xl flex-shrink-0">
                  {info.icon}
                </div>
                <div>
                  <span className="text-[10px] font-bold tracking-widest text-[#0B4F6C]/70 uppercase block mb-2">
                    {info.label}
                  </span>
                  {info.link ? (
                    <a 
                      href={info.link}
                      className="text-2xl font-heading font-bold text-[#0B4F6C] hover:text-[#ed1c24] transition-colors"
                    >
                      {info.value}
                    </a>
                  ) : (
                    <p className="text-2xl font-heading font-bold text-[#0B4F6C]">
                      {info.value}
                    </p>
                  )}
                </div>
        ...
        <div className="bg-gradient-to-br from-[#f8f9fa] to-white p-12 rounded-3xl shadow-2xl border border-black/5 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h2 className="font-heading text-3xl font-bold uppercase tracking-tight text-[#0B4F6C]">Send Message</h2>
            </div>
            
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-[#0B4F6C] uppercase tracking-wider">Your Name *</label>
                  <input 
                    type="text" 
                    name="name"
                    required
                    ...
                    className="w-full bg-white border-2 border-[#0B4F6C]/20 rounded-xl p-4 focus:outline-none focus:border-[#0B4F6C] transition-all text-black placeholder:text-black/40 shadow-sm hover:shadow-md" 
                    placeholder="Enter your full name"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-[#0B4F6C] uppercase tracking-wider">Email Address *</label>
                  <input 
                    type="email" 
                    name="email"
                    required
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#0B4F6C] uppercase tracking-wider">Phone Number</label>
                <input 
                  type="tel" 
                  name="phone"
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#0B4F6C] uppercase tracking-wider">Subject *</label>
                <input 
                  type="text" 
                  name="subject"
                  required
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#0B4F6C] uppercase tracking-wider">Your Message *</label>
                <textarea 
                  rows={6} 
                  name="message"
                  required
                  ...
                  onChange={handleInputChange}
                  className="w-full bg-white border-2 border-[#0B4F6C]/20 rounded-xl p-4 focus:outline-none focus:border-[#0B4F6C] transition-all text-black placeholder:text-black/40 resize-none shadow-sm hover:shadow-md" 
              ...
              <button 
                type="submit"
                className="w-full py-6 bg-gradient-to-r from-[#0B4F6C] to-[#0B4F6C]/90 text-white font-bold uppercase tracking-[0.4em] text-sm rounded-xl shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group"
              >
      ...
      <section className="py-40 bg-[#f8f9fa] border-t border-black/5 relative overflow-hidden">
        ...
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 relative z-10">
          <div className="mb-16 text-center">
            <span className="text-[10px] font-bold tracking-[0.6em] text-[#0B4F6C] mb-8 block uppercase">Location</span>
          ...
          <div className="flex justify-center gap-8">
            <a 
              ...
              className="px-12 py-4 bg-[#0B4F6C] text-white font-bold uppercase tracking-[0.4em] text-[10px] hover:bg-[#ed1c24] transition-colors shadow-lg"
            >
              Get Directions
            </a>
            <a 
              href="tel:+919840000000"
              className="px-12 py-4 bg-white text-[#0B4F6C] border-2 border-[#0B4F6C] font-bold uppercase tracking-[0.4em] text-[10px] hover:bg-[#0B4F6C] hover:text-white transition-colors shadow-lg"
            >
              Call Now
            </a>
          </div>
