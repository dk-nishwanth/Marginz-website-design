  ...
  return (
    <div className="pt-48 bg-white text-black min-h-screen pb-40">
      ...
      <section className="px-6 md:px-12 max-w-[1800px] mx-auto mb-40">
        <span className="text-[10px] font-bold tracking-[0.6em] uppercase text-[#ed1c24] mb-8 block">OUR SUCCESS STORIES</span>
        <h1 className="font-heading text-7xl md:text-[10vw] font-bold tracking-tighter uppercase leading-[0.8] mb-12 text-[#0B4F6C]">
          Turning Challenges <br /><span className="text-[#ed1c24] italic">Into Opportunities</span>
        </h1>
            ...
            {PROJECTS.map((project, i) => (
              <div key={project.id} className="group relative overflow-hidden bg-white shadow-sm hover:shadow-2xl transition-all duration-700">
                ...
                <div className="p-8">
                  ...
                  <h4 className="font-heading text-xl font-bold uppercase tracking-tight text-[#0B4F6C] group-hover:text-[#ed1c24] transition-colors mb-4">
                    {project.title}
                  </h4>
      ...
      <section className="py-40 bg-white">
        <div className="max-w-[1800px] mx-auto px-6 md:px-12">
          <div className="mb-24 text-center">
            <span className="text-[10px] font-bold tracking-[0.6em] text-[#0B4F6C] mb-8 block uppercase">CLIENT TESTIMONIALS</span>
            <h2 className="font-heading text-6xl md:text-8xl font-bold tracking-tighter uppercase leading-[0.85] text-[#0B4F6C] mb-8">
              Trusted by Businesses <br /><span className="text-[#ed1c24]/30 italic">Worldwide</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {CLIENT_REVIEWS.map((review, i) => (
              <div key={review.id} className="p-12 bg-[#f9f9f9] border-l-8 border-[#0B4F6C] hover:bg-white transition-all group shadow-sm hover:shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="mb-6">
                    <span className="text-[10px] font-bold tracking-[0.4em] uppercase text-[#ed1c24] block mb-4">
                      {review.project}
                    </span>
