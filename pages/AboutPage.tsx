...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="pt-48 bg-white text-black min-h-screen">
      {/* Hero Section */}
      <section className="px-6 md:px-12 max-w-[1800px] mx-auto mb-20 md:mb-40">
        ...
        <h1 className="font-heading text-4xl sm:text-6xl md:text-[11vw] font-bold tracking-tighter uppercase leading-[0.8] mb-8 md:mb-12 text-[#165a72]">
          Delivering <br /><span className="text-[#165a72]/40">Trust Through</span><br /><span className="text-[#ed1c24] italic">Knowledge</span>
        </h1>
        <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-black leading-[1.1] font-medium mb-6 md:mb-8 tracking-tight max-w-4xl">
      ...
      <section className="py-20 md:py-40 bg-[#f8f9fa] border-y border-black/5">
        <div className="max-w-[1800px] mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-12 lg:gap-24">
            ...
            <div className="mb-12 md:mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-black/10">
                {[
                  ...
                  <div key={v.t} className="p-6 md:p-12 bg-white flex flex-col justify-between min-h-[200px] md:aspect-square group">
          ...
          <div className="min-h-[400px] md:aspect-square bg-[#165a72] p-8 md:p-16 flex flex-col justify-end text-white shadow-3xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="font-heading text-4xl md:text-6xl font-bold uppercase mb-6 md:mb-8 leading-none">Brick by Brick.</h3>
              <p className="text-base md:text-lg opacity-90 font-light mb-6 md:mb-8">
              ...
              <p className="text-sm md:text-base opacity-80 font-light mb-8 md:mb-12">
              ...
              <div className="w-16 h-16 md:w-20 md:h-20 bg-[#ed1c24] flex items-center justify-center rounded-full group cursor-pointer hover:scale-110 transition-transform">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div>
              ...
              <div className="space-y-6 md:space-y-8">
                <div className="p-6 md:p-8 bg-[#f9f9f9] border-l-4 md:border-l-8 border-[#165a72]">
                ...
                <div className="p-6 md:p-8 bg-[#f9f9f9] border-l-4 md:border-l-8 border-[#ed1c24]">
                  <h4 className="font-heading text-lg md:text-xl font-bold uppercase tracking-tight text-[#165a72] mb-3 md:mb-4">
                    Academic Excellence
                  </h4>
                  <p className="text-sm md:text-base text-black/80 leading-relaxed">
              ...
              <div key={service.id} className="bg-white border border-black/5 overflow-hidden shadow-sm hover:shadow-lg transition-all">
                ...
                {expandedService === service.id && (
                  <div className="px-4 md:px-8 pb-4 md:pb-8 border-t border-black/5">
                    <div className="pt-4 md:pt-8 grid md:grid-cols-2 gap-6 md:gap-8">
                      <div>
